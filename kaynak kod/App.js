...
import Yasaklar from './src/screen/Yasaklar';
...
function YasaklarStack(){
  return(
    <Stack.Navigator headerMode="none">
      <Stack.Screen name="Yasaklar" component={Yasaklar} />
    </Stack.Navigator>
  );
} 
...
function TabNavigator(){
  ...
  >
    ...
    <Tab.Screen name="Yasaklar" component={YasaklarStack} />
